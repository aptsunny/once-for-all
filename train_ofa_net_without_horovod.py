...
if __name__ == '__main__':
    ...
    net = OFAMobileNetV3(
        n_classes=1000, bn_param=(args.bn_momentum, args.bn_eps),
    ...
    if args.task == 'kernel':
        ...
        from elastic_nn.training.progressive_shrinking import supporting_elastic_depth_without_horovod
        supporting_elastic_depth_without_horovod(train, distributed_run_manager, args, validate_func_dict, net, args.path)
    else:
