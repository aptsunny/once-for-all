...
from imagenet_codebase.run_manager import DistributedImageNetRunConfig, ImagenetRunConfig
...
if __name__ == '__main__':
    ...
    run_config = ImagenetRunConfig(**args.__dict__, num_replicas=num_gpus, rank=hvd.rank())
